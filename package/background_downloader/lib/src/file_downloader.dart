...
interface class FileDownloader {
  ...
  FileDownloader? registerCallbacks(
    ...
    if (taskCompleteCallback != null && _downloader is NativeDownloader) {
      final data = PluginUtilities.getCallbackHandle(taskCompleteCallback);
      if (data == null) throw 'callback is not a top-level or static function';

      (_downloader as NativeDownloader).registerTaskCompleteCallback(data.toRawHandle());
    }
    return this;
  }
